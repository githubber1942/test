        ...
        <script>
            $(document).ready(function() {
                $('#subscribers-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        "url": "{{ route('subscribers-next', ['endpoint' => 'https://connect.mailerlite.com/api/subscribers']) }}",
                        "type": "GET",
                        "data": function (d) {
                            d.endpoint = "{{ session('endpoint') }}";
                        },
                    },
                    columns: [
                        { data: 'email' },
            ...
            // console.log(@json(json_decode(session('links'))));
            console.log(@json(session('endpoint')));
        </script>
    </body>
</html>