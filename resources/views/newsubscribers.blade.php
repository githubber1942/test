        ...
        <script>
            $(document).ready(function() {
                let table = $('#subscribers-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('newsubscribers.data') }}",
                    columns: [
                        { data: 'email', fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                            $(nTd).css('cursor', 'pointer').click(function() {
                                showAndPopulateForm(oData);
                            });
                        }},
                        { data: 'name' },
                        { data: 'country' },
                        ...
                        { data: 'id', render: function(data, type, row, meta) {
                            return '<button class="delete" data-id="' + data + '">Delete</button>';
                        } }
                    ],
                ...
                $('#subscribers-table').on('click', 'button.delete', function () {
                    ...
                    $.ajax({
                        ...
                        error: function () {
                            alert('Error occurred deleting the subscriber')
                        },
                    })
                });
            });
            ...
            function showAndPopulateForm(rowData) {
